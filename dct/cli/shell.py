...
class Shell:
        ...
        def run_member(member: dict) -> tuple[str, str]:
            ...
            if provider_alias:
                ...
                if resolved:
                    ...
                    return (
                        role,
                        f"[ERROR] provider '{provider_alias}' not found",
                    )
    ...
    def run(self):
        ...
        COMMAND_HELP = {
            ...
            "/add-openai": "Register an OpenAI-compatible server",
            "/add-provider": "Register a cloud provider API",
            ...
            "/agentoff": "Turn off agent mode",
            "/goal": "Run agent autonomously in Goal Mode",
            "/skills": "List available skills",
            "/skill add": "Add a new skill",
            "/skill remove": "Remove a skill",
            "/skill show": "Show details of a skill",
            "/squad list": "List all agent squads",
            "/squads": "List all agent squads",
            "/squad create": "Create a new squad",
            "/squad add": "Add an agent to a squad",
            "/squad remove": "Remove an agent from a squad",
