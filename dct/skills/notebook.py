...
def edit_notebook_cell(notebook_path: str, cell_index: int, new_source: str, edit_mode: str = "replace") -> NotebookResult:
    ...
    try:
        ...
        if edit_mode == "replace":
            if cell_index < 0 or cell_index >= len(cells):
                return NotebookResult(False, f"Cell index {cell_index} out of bounds (0-{len(cells)-1}).")
